...
function AdminLayout() {
  ...
  if (isAdmin) tabs.push({ to: "/admin/regioes", label: "Regiões", icon: MapPin, exact: false });
  if (isAdmin) tabs.push({ to: "/admin/satisfacao", label: "Satisfação", icon: Star, exact: false });
